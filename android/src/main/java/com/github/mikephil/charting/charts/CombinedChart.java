...
public class CombinedChart extends BarLineChartBase<CombinedData> implements CombinedDataProvider {
    ...
    private boolean mDrawRoundedBarEnabled = false;
    ...
    @Override
    public boolean isDrawRoundedBarEnabled(){
        return mDrawRoundedBarEnabled;
    }
    ...
    public void setDrawRoundedBarEnabled(boolean enabled) {
        mDrawRoundedBarEnabled = enabled;
    }
